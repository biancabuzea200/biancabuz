          ...
          <div className="row flex justify-center items-center">
            <div className="col text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a href="https://www.linkedin.com/in/bianca-andreea-buzea/" target="_blank" rel="noreferrer" className="text-black dark:text-white hover:text-ds-blue-primary dark:hover:text-ds-blue-accent">
                ...
                <a href="https://github.com/biancabuzea200" target="_blank" rel="noreferrer" className="text-[#333] dark:text-[#f5f5f5] hover:text-ds-blue-primary dark:hover:text-ds-blue-accent">
