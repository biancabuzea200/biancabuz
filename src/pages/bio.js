  ...
  return (
    <Layout title="Short Bio" description="Short bio of Bianca Buzea">
      ...
      <main style={{ maxWidth: '720px', margin: '0 auto', padding: '3rem 1.5rem', lineHeight: '1.8' }}>
        ...
        <br />
        <p>Growing up in a village of fewer than 3,000 people taught me early that effort without understanding systems doesn't compound. My first opportunities to see the world came from learning. Winning national French Olympiads earned me international trips my family couldn't otherwise afford. Those experiences became my first passport to the world. Literally.</p>
        <p>They led me to study Computer Science abroad in Scotland, start my career as a Solutions Architect at AWS, and eventually move full-time into the Web3 startup space and Developer Relations.</p>
        <p>Along the way, I realized my real strength wasn't just technical execution. It was making complex, undervalued systems legible. Careers, incentives, education paths, financial decisions. The things that quietly shape one's trajectory but are rarely explained.</p>
        <p>That's why I founded <strong>DevRel Uni</strong>, the first program dedicated to helping people break into Developer Relations. Since 2022, we've shipped 7 cohorts, taught participants from 55+ countries, and supported protocols across Web3 with DevRel talent.</p>
